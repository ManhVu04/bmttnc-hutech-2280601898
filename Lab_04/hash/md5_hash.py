...
def md5(message):
    ...
    # Tiền xử lý chuỗi ban đầu
    original_len = len(message) * 8
    message += b'\x80'
    while (len(message) % 64) != 56:
        message += b'\x00'
    
    # Thêm chiều dài ban đầu vào cuối (64-bit little-endian)
    ...
    for i in range(0, len(message), 64):
        ...
        for j in range(64):
            ...
            d = c
            c = b
            b = (b + left_rotate((a + f + K[j] + words[g]) & 0xFFFFFFFF, r[j])) & 0xFFFFFFFF
            a = temp
